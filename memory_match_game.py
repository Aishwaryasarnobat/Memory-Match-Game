...
# Variables
image_files = [f"{i}.jpg" for i in range(1, 9)] * 2  # Pairs of images
...
def flip_card(index):
    ...
    if len(flipped_cards) < 2 and index not in flipped_cards:
        buttons[index].config(image=images[image_files[index]])
